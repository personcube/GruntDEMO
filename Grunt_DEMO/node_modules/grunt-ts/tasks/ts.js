...
define(["require", "exports", 'lodash', 'path', 'fs', './modules/utils', './modules/compile', './modules/reference', './modules/amdLoader', './modules/html2ts', './modules/templateCache', './modules/transformers'], function(require, exports, _, path, fs, utils, compileModule, referenceModule, amdLoaderModule, html2tsModule, templateCacheModule, transformers) {
